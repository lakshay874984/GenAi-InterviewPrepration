...
const { generateResumePdf } = require("../services/ai.service.js")
...
async function generateInterviewReportController(req, res) {
    ...
    // Handle file upload - if resume file is provided
    if (resumeFile) {
        resumeContent = await (new pdfParse.PDFParse(Uint8Array.from(resumeFile.buffer))).getText()
